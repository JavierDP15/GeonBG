...
@Component({
  selector: 'app-hoja-personaje-selec-prueba',
  templateUrl: './hoja-personaje-selec-prueba.page.html',
  styleUrls: ['./hoja-personaje-selec-prueba.page.scss'],
  standalone: true,
  imports: [
    IonContent, 
    IonHeader, 
...
export class HojaPersonajeSelecPagePrueba implements OnInit {
